...
function createNode(nodeName, isSvg) {
  var node = isSvg
    ? ownerDocument.createElementNS('http://www.w3.org/2000/svg', nodeName)
...
/** Preserve the paren document for createElement/createTextNode calls across windows */
...
function diff(dom, vnode, context, mountAll, parent, componentRoot) {
  ...
  if (diffLevel === 0) {
    ownerDocument = parent ? parent.ownerDocument : document;
  }
...
function idiff(dom, vnode, context, mountAll, componentRoot) {
  ...
  if (typeof vnode === 'string' || typeof vnode === 'number') {
    ...
    if (
      ...
      out = ownerDocument.createTextNode(vnode);
      if (dom) {
